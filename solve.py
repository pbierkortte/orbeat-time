...
ORIGINAL_EDGE_CASES_DATA = [
    ...
    (
        "1970-01-05T00:00:10.546+00:00",
        "00007000",
    ),  # This was for a time before 10:00 UTC
...
print("-" * 70)
print(
    f"{'Orbeat Code':<12} | {'Original Ref DT':<30} | {'New Decoded Timestamp (ms)':<28} | {'New Decoded ISO DT':<30}"
)
print("-" * 70)
...
for original_dt_str, orbeat_code in ORIGINAL_EDGE_CASES_DATA:
    ...
    try:
        ...
        print(
            f"{orbeat_code:<12} | {original_dt_str:<30} | {decoded_ms:<28.3f} | {decoded_dt.isoformat():<30}"
        )
...
print(
    "should produce the given 'Orbeat Code'. This is the start of the Orbeat 'beat' interval."
)
print(
    "The original reference datetime was used to guide the search for this new timestamp."
)
